...
resource_group = 'aml-quickstarts-132714'
workspace_name = 'quick-starts-ws-132714'
...
def clean_data(data):
    ...
    return (x_df_automl,x_df,y_df)
    
x_automl,x, y = clean_data(ds)
...
x_train_automl, x_test_automl,x_train, x_test, y_train, y_test = train_test_split(x_automl,x,y,test_size=0.25,random_state=42)
x_train_automl, x_validation_automl = train_test_split(x_automl,test_size=0.25,random_state=42)

x_train_automl.to_csv("LV_github_automl_train.csv")
x_validation_automl.to_csv("LV_github_automl_validation.csv")
x_test_automl.to_csv("LV_github_automl_test.csv")
